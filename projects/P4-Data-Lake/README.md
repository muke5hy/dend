...
<p align="center"><img src="images/spark.svg" style="height: 100%; width: 100%; max-width: 200px" /></p>

## Introduction
We are responsible for Data Lake with Apache Spark for the analytics team at Sparkify. They were interested in analyzing data collected on songs and user activity through their new music streaming app. Currently, the data is in JSON files, we should query the data on large amount data set. 
