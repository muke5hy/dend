...
os.environ["AWS_ACCESS_KEY_ID"] = config.get('aws',
                                             'AWS_ACCESS_KEY_ID')
...
def process_song_data(spark, input_data, output_data):
    """ Process song data and creates parquet files
    
    Arguments:
        spark {[type]} -- Spark session
        input_data {[type]} -- Input file 
        output_data {[type]} -- Output file
    """
...
def process_log_data(spark, input_data, output_data):
    """Process log data and writes to parquet file format. 
